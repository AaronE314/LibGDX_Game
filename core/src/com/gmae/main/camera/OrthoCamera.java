...
public class OrthoCamera extends OrthographicCamera {
    ...
    public OrthoCamera() {
        this(new VirtualViewport(Physics_Test.WIDTH, Physics_Test.HEIGHT));
    }
    ...
    public void resize() {
        VirtualViewport virtualViewport = new VirtualViewport(Physics_Test.WIDTH, Physics_Test.HEIGHT);
